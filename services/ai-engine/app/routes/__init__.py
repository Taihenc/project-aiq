...
v1_router.include_router(completion.router, prefix="/completions", tags=["completions"])
...
# v2_router.include_router(v2_completion.router, prefix="/completions", tags=["completions"])
