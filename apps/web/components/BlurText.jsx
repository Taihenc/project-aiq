...
const BlurText = ({
  ...
  useEffect(() => {
    if (!animateInView || !ref.current) return;
  ...
  }, [threshold, rootMargin, animateInView]);
  ...
  const isFixed = enableGradientFix && animationComplete;

  const containerStyle = isFixed
    ? { display: 'inline' }
    : { display: 'inline-flex', flexWrap: 'wrap' };

  const childStyle = isFixed
    ? { display: 'inline' }
